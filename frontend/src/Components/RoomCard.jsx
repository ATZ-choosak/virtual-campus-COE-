    ...
    <React.Fragment>
      ...
      >
        <div className="p-10 bg-white rounded-lg max-w-lg min-w-80">
          <p className="font-bold text-lg">{data.room_name} (ID : {data.room_id})</p>
          <p className="bg-gray-200 p-2 rounded-lg">{data.description}</p>
      ...
      <div className="w-full bg-white shadow-md p-4 rounded-lg space-y-4 h-fit">
        ...
        <p className="text-sm truncate">ID : {data.room_id}</p>
